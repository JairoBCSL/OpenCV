...
e executando o programa, obtemos uma imagem equalizada não tão agradável link:/imagens/carroeq.png[*_Carrão Equalizado_*]

image:/imagens/carroeq.png[Cachorro Equalizada]

Para entender o código vamos separa-lo por parte:
asdasd
